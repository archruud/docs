# 06 — Nettverk & Samba Client

*[English (primary)](network.md) — norsk versjon*
...
- Loggfilnavnet er konsekvent `install-06-network-<dato>.log`
...
Full logg lagres automatisk i `~/install-06-network-<dato>.log`. Scriptet spør til slutt om du vil kjøre `scan-network` og åpne SMB-browseren i Dolphin med det samme.
